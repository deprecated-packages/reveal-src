...
namespace Reveal\Tests\LatteToPhpCompiler;
...
use LatteToPhpCompiler;
use Reveal\Tests\LatteToPhpCompiler\Source\FooPresenter;
use Reveal\Tests\LatteToPhpCompiler\Source\SomeNameControl;
...
final class LatteToPhpCompilerTest extends TestCase
{
     ...
     * @param \ValueObject\ComponentNameAndType[] $componentNamesAndtTypes
     */
    ...
    {
        $configs = [
            __DIR__ . '/../../../../packages/TemplatePHPStanCompiler/config/services.neon',
            __DIR__ . '/../../../../packages/LattePHPStanCompiler/config/services.neon',
